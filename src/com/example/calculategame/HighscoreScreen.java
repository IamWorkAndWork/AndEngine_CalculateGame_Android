...
public class HighscoreScreen extends GLScreen {
    ...
    public void present(float deltaTime) {
        ...
        batcher.drawSprite(160, 240, 320, 480, Assets.BackgroundTextureRegion);
        batcher.endBatch();
        ...
        batcher.drawSprite(160, 360, 160, 33, Assets.highScoresRegion);
        
        float y = 240;
        for(int i = 4; i >= 0; i--) {
            Assets.font.drawText(batcher, highScores[i], xOffset, y,7,14);
